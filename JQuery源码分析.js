//jquery-2.0.3.js  源码模块分析
(function(){
	(21,94)  //定义了一些变量和函数   jQuery=function(){}

	(96,233)	//给JQuery对象添加一些方法和属性

	(285,347)	//extend的定义：用于实现JQuery的继承包括静态的扩展 和实力方法 的扩展

	(349,817)	//jQuery.extend() 静态工具方法的扩展(jquery工具方法都作为JQuery的实例方法支持)

	(877,2856)	//sizzle:复杂选择器的实现，sizzle本身是一个福利的模块，如果在项目中只要用JQuery的功能，可以只有爱下载这个部分的代码

	(2880,3042)		//callbacks:回调对象		函数的统一管理
	
	(3043,3183)	//Deferred:延迟对象，对异步操作的统一管理

	(3186,3297)	//support:浏览器功能的检测
